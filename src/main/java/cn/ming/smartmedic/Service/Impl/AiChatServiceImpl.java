...
public class AiChatServiceImpl implements AiChatService {
    ...
    public String query(String queryMessage) {
        ...
        try {
            ...
            Message systemMsg = Message.builder().role(Role.SYSTEM.getValue()).content("你是吴明雨同学开发的智能医生，你只回答与医疗相关的问题，不要回答其他问题！").build();
    ...
    public static void main(String[] args) {
        ...
        aiChatService.apiKey = "sk-5e4131ddd09e406f9a5b656d000948b3";
        String query = aiChatService.query("如果吃布洛芬的话，剂量怎么把握");
